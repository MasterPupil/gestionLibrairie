...
export default function Create({ auth }) {
    ...
    return (
        // <AuthenticatedLayout user={auth.user} header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Ajouter Catégorie</h2>}>
        <div>
            ...
            <div className="container py-4">
                ...
                {recentlySuccessful && ( // Ou utiliser le flash message global
                    <div className="alert alert-success mb-3">Catégorie ajoutée !</div>
                )}
